...
export default function Home(){return <div className="app-page home-page">
  ...
  <style jsx>{`
    ...
    .home-page .editorial-hero{transform:scale(.94);transform-origin:top center;margin-bottom:-28px}
    ...
    @media(max-width:900px){.home-page .editorial-hero,.home-page #practice-by-test,.home-page .home-footer{transform:none;margin-bottom:0}.home-page .practice-card{min-height:92px;height:92px}.home-page .home-footer{padding-top:14px!important}}
    @media(max-height:760px) and (min-width:901px){.home-page .editorial-hero{transform:scale(.9);margin-bottom:-42px}.home-page #practice-by-test{transform:scale(.9);margin-bottom:-28px}.home-page .practice-card{min-height:84px;height:84px}}
  `}</style>
</div>}
