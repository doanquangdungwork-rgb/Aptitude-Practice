...
function PracticeContent(){
  ...
  return <div className="app-page practice-library-page">
    ...
    <style jsx>{`
      ...
      .library-summary{display:flex;justify-content:space-between;gap:20px;padding:12px 0 12px;font-size:10px;color:#aaa7a0}
      .practice-category-nav{display:flex;align-items:center;justify-content:space-between;flex-wrap:nowrap;gap:28px;padding:0 0 12px;border-bottom:1px solid var(--line);overflow:hidden}
      .practice-category-nav .category-buttons{display:flex;align-items:center;gap:25px;min-width:0;flex:1;overflow:hidden;white-space:nowrap}
      .practice-category-nav .category-buttons button{flex:0 0 auto;white-space:nowrap}
      .practice-category-nav .search-wrap{flex:0 0 420px}
      .test-library-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin-top:14px}.test-library-card{min-width:0;border:1px solid #ddd9d1;background:#fff;display:flex;flex-direction:column;overflow:hidden;min-height:305px}
      ...
      @media(max-width:1200px){.practice-category-nav .search-wrap{flex-basis:260px}.practice-category-nav .category-buttons{gap:18px}.test-library-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
      @media(max-width:900px){.practice-library-page{padding-top:20px}.practice-library-header{padding-top:34px}.practice-category-nav{align-items:stretch;flex-direction:column;gap:9px;overflow:visible}.practice-category-nav .category-buttons{width:100%;flex:none;overflow-x:auto;overflow-y:hidden;padding-bottom:2px}.practice-category-nav .search-wrap{width:100%;flex-basis:auto}.test-library-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.library-count strong{font-size:32px}}
