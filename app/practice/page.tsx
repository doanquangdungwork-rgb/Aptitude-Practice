...
function PracticeContent(){
  ...
  return <div className="app-page practice-library-page">
    ...
    <style jsx>{`
      .practice-library-page{padding-top:20px;padding-bottom:70px}.practice-category-nav{padding:0 0 11px;border-bottom:1px solid var(--line)}.practice-category-nav .category-buttons{gap:25px}.practice-library-header{display:flex;align-items:end;justify-content:space-between;gap:30px;padding:48px 0 26px;border-bottom:1px solid var(--line)}.practice-library-header h1{margin-top:7px;font-size:clamp(40px,5vw,64px);line-height:.96;letter-spacing:-.065em;font-weight:500}.practice-library-description{max-width:540px;margin-top:10px;font-size:13px;line-height:1.6;color:var(--muted)}.library-count{text-align:right;flex:0 0 auto}.library-count strong{display:block;font-size:40px;line-height:.9;font-weight:500;letter-spacing:-.06em}.library-count span{display:block;margin-top:8px;font-size:10px;color:var(--muted);text-transform:uppercase;letter-spacing:.12em}.library-summary{display:flex;justify-content:space-between;gap:20px;padding:12px 0 16px;font-size:10px;color:#aaa7a0}.test-library-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px}.test-library-card{min-width:0;border:1px solid #ddd9d1;background:#fff;display:flex;flex-direction:column;overflow:hidden;min-height:305px}.test-card-art{height:78px;position:relative;display:flex;align-items:center;justify-content:center;border-bottom:1px solid rgba(34,35,33,.12);overflow:hidden}.test-card-art:before,.test-card-art:after{content:"";position:absolute;border:1px solid rgba(34,35,33,.45);border-radius:50%}.test-card-art:before{width:38px;height:38px}.test-card-art:after{width:38px;height:38px;transform:translateX(17px)}.test-card-art span{position:relative;z-index:2;font-size:25px;font-weight:300;line-height:1}.test-card-art small{position:absolute;left:10px;top:10px;font-size:9px;letter-spacing:.1em;color:rgba(34,35,33,.55)}.tone-lavender .test-card-art:before,.tone-lavender .test-card-art:after{border-radius:4px}.tone-lime .test-card-art:before{border-radius:50%}.tone-mint .test-card-art:before{border-radius:0}.tone-sky .test-card-art:before{transform:rotate(45deg)}.tone-peach .test-card-art:after{border-radius:5px}.tone-pink .test-card-art{background:var(--pink)}.tone-lavender .test-card-art{background:var(--lav)}.tone-lime .test-card-art{background:#e8ef9d}.tone-mint .test-card-art{background:var(--mint)}.tone-sky .test-card-art{background:var(--sky)}.tone-peach .test-card-art{background:var(--peach)}.test-card-body{position:relative;display:flex;flex:1;flex-direction:column;padding:11px 11px 10px;background:rgba(255,255,255,.86)}.test-card-topline{display:flex;justify-content:space-between;align-items:center}.test-star{border:0;background:transparent;padding:0;font-size:17px;line-height:1;color:#8f8b83}.test-star.starred{color:#3f3e39}.test-card-body h2{margin-top:17px;min-height:38px;font-size:14px;line-height:1.2;font-weight:500;letter-spacing:-.025em}.test-card-meta{margin-top:9px;font-size:9.5px;color:#89857d}.test-card-meta span{padding:0 3px}.test-card-status{margin-top:5px;font-size:9px;color:#aaa7a0}.test-start{display:flex;align-items:center;justify-content:center;gap:7px;margin-top:auto;padding:8px 10px;background:#222321;color:#fff;font-size:10px;font-weight:600;border:0;width:100%}.test-start span{font-size:14px;line-height:0}.library-pagination{display:flex;align-items:center;justify-content:space-between;gap:20px;margin-top:17px;padding-top:13px;border-top:1px solid var(--line);font-size:10px;color:#aaa7a0}.page-controls{display:flex;gap:4px}.page-controls button{width:27px;height:27px;border:1px solid #ddd9d1;background:#fff;color:#55524d;font-size:10px}.page-controls button.current{background:#222321;color:#fff;border-color:#222321}.page-controls button:disabled{opacity:.35;cursor:default}.launch-overlay{position:fixed;inset:0;z-index:100;display:grid;place-items:center;padding:24px;background:rgba(31,31,28,.32);backdrop-filter:blur(5px)}.launch-modal{position:relative;width:min(520px,100%);padding:26px;border:1px solid #dedbd3;border-radius:18px;background:#fffefa;box-shadow:0 24px 80px rgba(28,27,24,.18)}.launch-close{position:absolute;right:17px;top:14px;border:0;background:transparent;font-size:24px;line-height:1;color:#8d8981}.launch-art{height:92px;margin-bottom:22px;border:1px solid rgba(34,35,33,.12);display:grid;place-items:center;background:var(--pink);overflow:hidden;position:relative}.launch-art:before,.launch-art:after{content:"";position:absolute;border:1px solid rgba(34,35,33,.35);border-radius:50%;width:54px;height:54px}.launch-art:after{transform:translateX(24px)}.launch-art span{position:relative;z-index:2;font-size:30px}.launch-modal h2{margin-top:8px;font-size:32px;line-height:1;letter-spacing:-.05em;font-weight:500}.launch-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:17px}.launch-meta span{padding:7px 10px;border-radius:999px;background:#f2f1ec;font-size:10px;font-weight:700;color:#69665f}.launch-copy{margin-top:18px;max-width:430px;font-size:12px;line-height:1.7;color:#99968f}.launch-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:24px}.launch-actions .yellow-button{border:0}.launch-actions .outline-action{background:#fff}
      @media(max-width:1100px){.test-library-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:900px){.practice-library-page{padding-top:20px}.practice-library-header{padding-top:34px}.test-library-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.library-count strong{font-size:32px}}@media(max-width:560px){.practice-library-header{display:block}.library-count{text-align:left;margin-top:18px}.library-summary{display:block}.library-summary span+span{display:block;margin-top:5px}.test-library-grid{grid-template-columns:1fr}.test-library-card{min-height:300px}.library-pagination{align-items:flex-start;flex-direction:column}.practice-category-nav .category-buttons{gap:20px}.launch-modal{padding:21px}.launch-modal h2{font-size:27px}}
    `}</style>
  </div>
}
