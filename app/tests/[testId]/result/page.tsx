...
export default function ResultPage() {
  ...
  const selectedReferenceMaterials = referenceMaterials.length ? referenceMaterials : referenceMaterialsForQuestion(testId, selectedQuestion?.number ?? 1);
