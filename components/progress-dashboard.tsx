...
export default function ProgressDashboard({compact=false}:{compact?:boolean}){
  ...
  return <div className="editorial-dashboard">
    ...
    <div className="dash-bottom-grid"><Link href="/bookmarks" className="dash-action"><div className="dash-action-kicker">04 · Saved</div><div className="dash-action-title">{bookmarks} bookmarks.</div><p className="dash-action-copy">Questions you chose to revisit.</p></Link><Link href="/practice" className="dash-action"><div className="dash-action-kicker">05 · Next</div><div className="dash-action-title">Continue practicing.</div><p className="dash-action-copy">Pick an unfinished test and keep going.</p></Link></div>
  </div>;
}
