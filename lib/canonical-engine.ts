...
export type CanonicalQuestion = { id: string; number: number; subquestion?: string | null; prompt: { blocks: ContentBlock[] }; options: CanonicalOption[]; response: CanonicalResponse; answer: CanonicalAnswer; explanation?: { blocks: ContentBlock[] } | null; taxonomy?: { pillar?: string; subtype?: string }; source?: Record<string, unknown> };
