...
const test031Questions: ExtraQuestion[] = deductiveTest2.map(([number, t, o, a]) => ({ id: `TEST_031_Q${number}`, testId: "TEST_031", number, p: "deductive", s: "deductive_reasoning", t, o, a }));
const test032Questions: ExtraQuestion[] = deductiveTest3.map(([number, t, o, a]) => ({ id: `TEST_032_Q${number}`, testId: "TEST_032", number, p: "deductive", s: "deductive_reasoning", t, o, a }));
const test033Questions: ExtraQuestion[] = deductiveTest4.map(([number, t, o, a]) => ({ id: `TEST_033_Q${number}`, testId: "TEST_033", number, p: "deductive", s: "deductive_reasoning", t, o, a }));
