...
export function referenceMaterialsForQuestion(testId: string, questionNumber: number): ReferenceMaterial[] {
  ...
  if (testId === "TEST_030" && (questionNumber === 5 || questionNumber === 6)) return [{ id: "DED1_BROADBAND", assetRef: "TEST_030_BROADBAND.svg", label: "Broadband plans" }];
  if (testId === "TEST_030" && (questionNumber === 17 || questionNumber === 18)) return [{ id: "DED1_CONTRACTS", assetRef: "TEST_030_CONTRACTS.svg", label: "Salaries & contracts" }];
